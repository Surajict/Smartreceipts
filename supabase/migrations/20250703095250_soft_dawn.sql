/*
  # Complete Supabase Integration with Latest Changes

  1. Database Schema
    - Ensure all tables exist with proper structure
    - Add new columns for enhanced receipt scanning
    - Create comprehensive indexes for performance

  2. Storage Configuration
    - Configure receipt-images bucket with proper settings
    - Set up profile-pictures bucket
    - Create secure storage policies

  3. Functions & Views
    - Enhanced receipt processing functions
    - Warranty calculation and alerts
    - User statistics and search capabilities
  ...
  5. User Management
    ...
    - Trigger functions for user lifecycle
*/
...
-- Initialize profiles and settings for existing users who don't have them
INSERT INTO public.users (id, email, full_name)
SELECT 
  au.id, 
  COALESCE(au.email, ''), 
